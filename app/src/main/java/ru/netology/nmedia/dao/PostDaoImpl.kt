...
class PostDaoImpl(private val db: SQLiteDatabase) : PostDao {
    ...
    object PostColumns {
        ...
        const val COLUMN_PREVIEW_IMAGE_URL = "previewImageUrl"
        const val COLUMN_PREVIEW_VIDEO_TEXT = "videoPreviewText"
        const val COLUMN_VIDEO_VIEWS = "videoViewsCount"
        val ALL_COLUMNS = arrayOf(
            ...
            COLUMN_VIEWS,
            COLUMN_VIDEO_URL,
            COLUMN_PREVIEW_IMAGE_URL,
            COLUMN_PREVIEW_VIDEO_TEXT,
            COLUMN_VIDEO_VIEWS,
        )
    }
